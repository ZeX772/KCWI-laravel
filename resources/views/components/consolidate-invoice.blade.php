...
<script type="text/javascript">
    $(function() {
        $('.invoice-consolidate #consolidate-table').on('click', 'tr', function(){
            ...
            if( entryID ) {
                ...
                $('.invoice-consolidate .consolidate-details_container #detail-status').text(ucfirst(selectedEntry.status));
                $('.invoice-consolidate .consolidate-details_container #detail-consolidate_no').text(selectedEntry.consolidate_no);
                $('.invoice-consolidate .consolidate-details_container #detail-payment_date').text( moment(selectedEntry.date).format('MM/DD/YYYY h:mm A'));
                $('.invoice-consolidate .consolidate-details_container #detail-total_amount').text( selectedEntry.total_amount ? ("$" + selectedEntry.total_amount): "-" );
                $('.invoice-consolidate .consolidate-details_container #detail-paid_amount').text( selectedEntry.paid_amount ? ("$" + selectedEntry.paid_amount): "-" );
                $('.invoice-consolidate .consolidate-details_container #detail-refunded_amount').text( selectedEntry.refunded_amount ? ("-$" + selectedEntry.refunded_amount): "-" );
                $('.invoice-consolidate .consolidate-details_container #detail-payment_method').text(selectedEntry.payment_method ?? "-");
            } else {
                $('.invoice-consolidate .consolidate-details_container #detail-status').text("-");
                $('.invoice-consolidate .consolidate-details_container #detail-consolidate_no').text("-");
                $('.invoice-consolidate .consolidate-details_container #detail-payment_date').text("-");
                $('.invoice-consolidate .consolidate-details_container #detail-total_amount').text("-");
                $('.invoice-consolidate .consolidate-details_container #detail-paid_amount').text("-");
                $('.invoice-consolidate .consolidate-details_container #detail-refunded_amount').text("-");
                $('.invoice-consolidate .consolidate-details_container #detail-payment_method').text("-");
            }
        });
    });
</script>