                        ...
                        <tbody>
                            @foreach( $coachComments as $coachComment )
                                <tr data-row_id="{{ $coachComment['id'] }}">
                                    ...
                                    <td class="text-left">{{ $coachComment['class_data']['course_class_code'] }}</td>
                                    <td class="text-left">{{ $coachComment['coach']['name'] }}</td>
                                    ...
                                    <td class="text-center">
                                        <div>
                                            <button type="button" class="view-button" data-row_id="{{ $coachComment['id'] }}" data-bs-toggle="modal" data-bs-target=".coach-comments_tab #comment-modal">
