...
<div class="d-xl-flex flex-column" id="content-wrapper"
    ...
    <form method="POST" action="{{ route('wave.change-password') }}">
        @csrf
        ...
        <div class="d-xl-flex d-xxl-flex justify-content-xl-center align-items-xl-center justify-content-xxl-center align-items-xxl-center"
            ...
            <div style="width: 50%;">
                ...
                <div style="position: relative; margin-top: 15px;">
                    <div style="display: flex; align-items: center;">
                        <input id="password" class="textField" type="password" name="password"
                            placeholder="Current Password" required style="outline:none;padding-left: 7.5%;">
                        <div id="togglePassword" class="frame-2608721 eye-icon" onclick="togglePassword()"
                            style="cursor: pointer;">
                            <svg class="eye-icn" fill="none" xmlns="http://www.w3.org/2000/svg"
                ...
                <div style="position: relative; margin-top: 15px;">
                    <div style="display: flex; align-items: center;">
                        <input id="new_password" class="textField" type="password" name="new_password"
                            ...
                            style="width:100%;outline:none;padding-left: 7.5%;margin-top:15px;">
                ...
                <div style="position: relative; margin-top: 15px;">
                    <div style="display: flex; align-items: center;">
                        <input id="password_confirmation" class="textField" type="password" name="password_confirmation"
                            ...
                            style="width:100%;outline:none;padding-left: 7.5%;margin-top:15px;">
                        <div id="togglePassword" class="frame-2608721 eye-icon" onclick="togglePasswordConfirmation()"
                            style="cursor: pointer;">
                            <svg class="eye-icn" fill="none" xmlns="http://www.w3.org/2000/svg"
                                style="height: 25px; width: 25px;">
                                <path
                ...
                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center">
                    <button id="changeBtn" class="button1" type="submit"
                        style="margin-top: 30px;width:100%;height:79.6px!important;">Change</button>
                </div>
            </div>
        </div>
    </form>
...
<script>
    @if(session('changePassword'))
        @if(session('changePassword')['status'] === 'fail')
            @php
                $changePasswordMessage = session('changePassword')['message'];
            @endphp
        ...
        @elseif(session('changePassword')['status'] === 'pass')
            @php
            $changePasswordMessage = session('changePassword')['message'];
            @endphp
            toastr.success("{{ $changePasswordMessage }}", { "timeOut": 12000 });
        @endif
        @php
