                ...
                <form id="staff-form" class="position-relative">
                    ...
                    <div class="container d-xxl-flex align-items-xxl-center form-input-container gap-4 mb-3">
                        ...
                        >
                            ...
                            <option value="archived" @if($user['status'] == 'archived') selected @endif>Archive</option>
                        </x-form-select>
                    </div>
                </form>
...
<script type="text/javascript">
    var errors = [];
    var selectedData = <?= json_encode($user) ?>;
    var formAction = '';
    ...
    $(function() {
        $('#process-save').on('click', async function(){
            ...
            await axios.post(`${getApiUrl()}/user/update/${selectedData.id}`, transformedData, {
                    headers: {
