 ...
 <div class="main-contents">
                   <div class="row g-0 d-xxl-flex justify-content-between">
                        <div class="col-auto d-xxl-flex align-items-xxl-center">
                            ...
                            <h1 style="color: #7A7A7A;font-size: 36px;font-family: Poppins, sans-serif;margin-left: 20px;">#VSA-RS2-0001</h1>
                        </div>
                        <div class="col-auto">
                                ...
                                <div id="tab-1" class="tab-pane active bootstrap_datatables" role="tabpanel" style="min-height: 0px;height: auto;">
                                    <div class="col d-xxl-flex justify-content-between align-items-xxl-center" style="padding-top: 10px;padding-bottom: 10px;">
                                        <div class="d-xxl-flex align-items-xxl-center">
                                            <h1 class="fw-normal text-nowrap d-xxl-flex" style="color: #3B3B3B;font-size: 20px;font-family: Poppins, sans-serif;">VSA-RS2-0001-01</h1><button class="btn btn-primary" type="button" style="padding: 0px;padding-right: 5px;padding-left: 5px;background: rgb(255,255,255);color: #3B3B3B;border-style: none;border-bottom-style: none;box-shadow: 1px 1px 4px 1px;margin-left: 15px;" data-bs-toggle="modal" data-bs-target="#modal-1"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-pencil">
                                    ...
                                    <div class="col d-xxl-flex justify-content-between align-items-xxl-center">
                                        <div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                                ...
                                                <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">04/02/2022</h1>
                                            </div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                                <h1 style="color: #3B3B3B;font-size: 14px;font-family: Poppins, sans-serif;font-weight: bold;">Time:</h1>
                                                <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">08:00 - 08:55</h1>
                                            </div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                        ...
                                        <div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                                ...
                                                <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">VSA</h1>
                                            </div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                                <h1 style="color: #3B3B3B;font-size: 14px;font-family: Poppins, sans-serif;font-weight: bold;">Facility:</h1>
                                                <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">VSA Main Pool</h1>
                                            </div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                                <h1 style="color: #3B3B3B;font-size: 14px;font-family: Poppins, sans-serif;font-weight: bold;">Level:</h1>
                                                <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">Ripplet Starter 2</h1>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="col d-xxl-flex align-items-xxl-start">
                                                ...
                                                <div>
                                                    <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">Coach Ng (Present)</h1>
                                                    <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">Coach Chan (Present)</h1>
                                                </div>
                                            </div>
                                        </div>
                                        <div>
                                            <div class="col d-xxl-flex align-items-xxl-center">
                                                ...
                                                <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;margin-left: 10px;">Please enter the message here... <br>Class remark here...</h1>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col">
