                ...
                <div style="width: 400px;">
                    <form action="#" method="post">
                        ...
                        <div style="margin-top: 30px;">
                            <h1 style="color: #636363;font-size: 14px;font-family: Poppins, sans-serif;">Enter code</h1><input name="otp" required maxlength="6" type="number" style="width: 100%;height: 48px;border-style: none;background: #F5F5F5;border-top-left-radius: 8px;border-top-right-radius: 8px;border-bottom-right-radius: 8px;border-bottom-left-radius: 8px;color: #3B3B3B;font-family: Poppins, sans-serif;padding-top: 1px;padding-left: 16px;">
                        </div>
                        @if (session('message'))
                        ...
                        @endif
                        <div class="d-xl-flex align-items-xl-center password-container " style="width: 100%;margin-top: 50px;"><button type="submit" class="btn btn-primary d-xl-flex justify-content-xl-center align-items-xl-center" role="button" style="width: 100%;height: 48px;background: #4A5C7A;font-family: Poppins, sans-serif;box-shadow: 0px 7px #39455b;border-top-left-radius: 8px;border-top-right-radius: 8px;border-bottom-right-radius: 8px;border-bottom-left-radius: 8px;border-style: none;border-left-style: none;border-left-color: var(--bs-btn-disabled-color);">Verify</button></div>
                        <input type="hidden" name="email" value="{{ $email }}" />
                    </form>
                    <form action="{{route('forgot-password')}}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="email" value="{{ $email }}" />
                        <button type="submit" style="color: #4A5C7A;font-size: 14px;font-family: Poppins, sans-serif;margin-top: 20px;">Resend Code</button>
                    </form>
