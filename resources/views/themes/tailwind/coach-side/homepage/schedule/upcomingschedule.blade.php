...
<div class="d-block" id="content-wrapper" style="padding-top: 50px;padding-bottom: 50px;padding-right: 50px;padding-left: 50px;background: var(--app-color-tone-bg-color, #F1F2F9);width: 100%;">
    <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24bb" style="margin-bottom: 10px;height: 31px; text-align: center;">Course</p>
    <div style="width: 100%; margin-bottom: 15px; position: relative;"><a href="{{ route('wave.schedule') }}"><button class="button2" type="button" style="position: relative; border: none; background-color: white; padding: 10px; border-radius: 10.3226px; box-shadow: 1px 1px 2px black; width: 40px; height: 40px;"><i class="fas fa-chevron-left"></i></button></a></div>

    <div class="d-md-flex d-lg-flex d-xl-flex justify-content-md-center justify-content-lg-center justify-content-xl-center" style="margin-bottom: 20px; margin-top: 20px;">
        <div style="fill: #FFF;filter: drop-shadow(0px 4px 4px rgba(35, 54, 86, 0.50));background-color: #ffffff;border-radius: 20px;width: 250px;">
            <button class="btn btn-primary" type="button" onclick="window.location.href='{{ route('wave.upcomingschedule', $entry['id']) }}'" style="width: 124px; background-color: var(--app-color-tone-secondary-2, #AAC9E4);filter: drop-shadow(0px 4px 4px rgba(35, 54, 86, 0.50));border-radius: 20px;border-style: none;padding-left: 20px;padding-right: 20px;color: #171433;">Upcoming</button>
            <button class="btn btn-primary" type="button" onclick="window.location.href='{{ route('wave.pastschedule', $entry['id']) }}'" style="width: 124px; border-color: white;border-style: none;background-color: white;color: #171433;border-radius: 20px;padding-left: 20px;padding-right: 20px; margin-left: -5px;">Past</button>
        </div>
    </div>
