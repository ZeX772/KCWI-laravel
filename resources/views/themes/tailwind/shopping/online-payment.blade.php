                        ...
                        <div class="divcard" style="padding-top: 20px; height: 118px; padding-bottom: 20px;">
                            <div class="d-xl-flex d-xxl-flex justify-content-evenly align-items-xl-center align-items-xxl-center"
                                ...
                                <img src="{{ asset('/themes/tailwind/images/VISA-logo.png') }}" id="image1"
                                    style="width: 62px; margin-bottom: 10px;">
                                <img src="{{ asset('/themes/tailwind/images/clipboard-image-66.png') }}" id="image2"
                                    style="width: 43px; margin-bottom: 10px;">
                                <img src="{{ asset('/themes/tailwind/images/fps.png') }}" id="image3"
                                    style="width: 49px; margin-bottom: 10px;">
                                <img src="{{ asset('/themes/tailwind/images/payme-logo.png') }}" id="image4"
                            ...
                            <div id="imageSelection"
                                ...
                                <div><input type="radio" name="imageSelection" style="width: 18px; height: 18px;"
                                        value="image1" onclick="changeImage(this)"></div>
                                <div><input type="radio" name="imageSelection" style="width: 18px; height: 18px;"
                                        value="image2" onclick="changeImage(this)"></div>
                                <div><input type="radio" name="imageSelection" style="width: 18px; height: 18px;"
                                        value="image3" onclick="changeImage(this)"></div>
                                <div><input type="radio" name="imageSelection" style="width: 18px; height: 18px;"
                                        value="image4" onclick="changeImage(this)"></div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#confirmPaymentBtn').click(function() {
                ...
                if (errors.length > 0) {
                    var errorMessage = "Please fill the following missing details:\n" + errors.join("\n");
                    alert(errorMessage);
                } else {
                    var data = {
                        cardName: cardName,
                    ...
                    $.ajax({
                        ...
                        <img src="{{ asset('themes/tailwind/images/clipboard-image-61.png') }}" style="width: 217px;">
                        <p class="p20b" style="text-align: center;"><strong>Thank you for your payment!</strong><br><br><strong>A receipt has been sent&nbsp;</strong><br><strong>in your "My Order"&nbsp;</strong><br><strong>to your records.</strong></p>
