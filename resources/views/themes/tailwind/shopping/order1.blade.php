...
@section('content')
<div class="d-flex flex-column" id="content-wrapper" style="padding-top: 50px;padding-bottom: 50px;padding-right: 50px;padding-left: 50px;background: var(--app-color-tone-bg-color, #F1F2F9);min-height: 100%;">
    <div class="d-md-flex d-xxl-flex justify-content-between align-items-md-center align-items-xxl-center">
        ...
        <p class="shopping d-xl-flex justify-content-xl-center align-items-xl-center p24bb" style="margin-bottom: 0px;height: 31px;text-align: center;margin-left:-140px;"><strong>My
                Order</strong></p>
        <div>
        </div>
    </div>
    <div class="d-md-flex d-lg-flex d-xl-flex d-xxl-flex justify-content-md-center justify-content-lg-center" style="margin-bottom: 20px;margin-top: 50px;">
        <div style="width: 60%;">
            <div>

                {{-- @dd($myOrderDetails); --}}
                <div class="d-xl-flex align-items-xl-center" style="margin-bottom: 20px;">
                    <img src="../themes/tailwind/images/clipboard-image-55.png" style="width: 16px;margin-right: 10px;margin-left:-60px;">
                ...
                <div class="box1 d-xl-flex divcard" style="padding: 15px;padding-left: 30px;min-height:250px;margin-bottom:20px;">
                    <div><img src=" {{ $myOrderDetail['stored_file_name'] }}" style="width: 160px;margin-left:0px;margin-top:30px;transform:translateX(-270px);margin-bottom:-80px;">
                    </div>
                    <div class="d-xxl-flex flex-column justify-content-xxl-center" style="margin-top:0px;">
                        <p class=" p18poppins" style="font-size:18px;font-weight:bold;margin-bottom: 0px;margin-top:-50px;">
                            {{ $myOrderDetail['product_name'] }}</p>
                        <div class="d-md-flex d-xxl-flex align-items-md-center align-items-xxl-center" style="margin-bottom: 5px;">
                            <p class="p16normal3" style="font-weight: bold;margin-bottom: 0px;margin-right: 10px;">
                                Colour: </p>
                            <p class="p16b" style="margin-bottom: 0px;color: #171433;">ROYAL BLUE(missing column)
                            </p>
                        </div>
                        <div class="d-md-flex d-xxl-flex align-items-md-center align-items-xxl-center" style="margin-bottom: 5px;">
                            <p class="p16normal3" style="font-weight: bold;margin-bottom: 0px;margin-right: 10px;">
                                Size: </p>
                            <p class="p16b" style="margin-bottom: 0px;color: #171433;">150(missing column) </p>
                        </div>
                        <div class="d-md-flex d-xxl-flex align-items-md-center align-items-xxl-center" style="margin-bottom: 5px;">
                            <p class="p16normal3" style="font-weight: bold;margin-bottom: 0px;margin-right: 10px;">
                                Qty: </p>
                            <p class="p16b" style="margin-bottom: 0px;color: #171433;">
                                {{ $myOrderDetail['quantity'] }} </p>
                        </div>
                        <div class="d-md-flex d-xxl-flex align-items-md-center align-items-xxl-center" style="margin-bottom: 5px;">
                            <p class="p16normal3" style="font-weight: bold;margin-bottom: 0px;margin-right: 10px;">
                                Order: </p>
                ...
                @php
                $totalFee += $myOrderDetail['unit_price'];
                @endphp
                @endforeach
                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center" style="margin-top: 20px;margin-bottom: 10px;margin-left:-60px;">
                    <img src="../themes/tailwind/images/clipboard-image-63.png" style="width: 16px;margin-right: 10px;">
                ...
                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center" style="margin-top: 20px;margin-bottom: 10px;margin-left:-60px;">
                    <img src="../themes/tailwind/images/clipboard-image-64.png" style="width: 23px;margin-right: 10px;">
                    <p class="p20b" style="margin-top: 0px;text-align: left;margin-bottom: 0px;">
                ...
                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center" style="margin-top: 20px;margin-bottom: 10px;margin-left:-60px;">
                    <img src="../themes/tailwind/images/clipboard-image-55.png" style="width: 16px;margin-right: 10px;">
                ...
                <div style="padding: 15px;padding-left: 30px;" class="divcard">
                    <div class="box1 d-xxl-flex flex-column align-items-xxl-start" style="width:137%;margin-left:-100px; padding: 15px;">
                        <div class="d-xl-flex d-xxl-flex align-items-xl-start align-items-xxl-start" style="margin-bottom: 10px;">
                ...
                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center" style="margin-top: 20px;margin-bottom: 10px;margin-left:-60px;">
                    <img src="../themes/tailwind/images/clipboard-image-64.png" style="width: 32px;margin-right: 10px;">
                    <p class="d-xxl-flex p20b" style="margin-top: 0px;text-align: left;margin-bottom: 0px;">
                        <strong>Invoice</strong>
                    </p>
                </div><a href="{{ route('wave.invoice2') }}" class="button1" type="button" style="width: 160px;border-radius:16px;text-decoration:none;color:white;">Preview</a>
            </div>
        </div>
    </div>
