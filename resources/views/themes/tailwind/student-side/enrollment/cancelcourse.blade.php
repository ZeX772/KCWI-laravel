...
@section('content')
            ...
            <div class="d-flex flex-column" id="content-wrapper"
                ...
                <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24bb"
                    style="margin-bottom: 0px;height: 31px;"><strong>Cancel Course</strong></p>
                <div class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center">
                    <div style="width: auto;">
                        <p class="p18b" style="margin-top: 50px;margin-bottom: 0px;"><strong>Choose Student and Cancel
                                Course</strong></p>
                                <form id="radioForm" action="{{ route('wave.storeCancelCourseStudentInfo') }}" method="post">
                                    @csrf
                                    @if (!empty($students))
