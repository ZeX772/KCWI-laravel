...
@section('content')
            ...
            <div class="d-flex flex-column" id="content-wrapper"
                ...
                <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24bb"
                    style="margin-bottom: 50px;height: 31px;"><strong>Cancel Course</strong></p>
                <div class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center" placeholder="">
                    <div style="width: 50%;" id="form-container">
                        <div style="margin-bottom: 20px;">
                            ...
                            <form id="cancelCourseForm" action="/cancelcourse1" method="post">
                                @csrf
                                <select class="select1" name="course" id="course"
                        ...
                        <div style="margin-bottom: 10px;">
                            <p class="text-start p18bb">Reason for cancelling the course</p>
                        </div>
                        <div style="margin-bottom: 20px; height: 38%;"><img
                            ...
                            <textarea class="textarea1" name="reasonCancel" id="reasonCancel" placeholder="Please specify..."></textarea>
                        </div>

                        <div class="d-xxl-flex justify-content-xxl-center"><button class="button1" id="submitBtn" type="button">Request to
                                Cancel</button></div>
                        </form>
        ...
        $(document).ready(function() {
            $('#form-container').on('click', '#submitBtn', async function(){
                ...
                let formData = {
                    ...
                    course_enrollment_id: selectedCourseEnrollment.id,
                    reason: reason,
                    refund_amount: selectedCourseEnrollment.total_fee,
                    from: 'customer cancel course',
                    invoice_id: selectedCourseEnrollment.invoice
                };
            ...
            $('#modal-1').on('hidden.bs.modal', function (e) {
                window.location = "{{ route('wave.cancelcourse') }}"
            });
        });
    </script>
@endsection
