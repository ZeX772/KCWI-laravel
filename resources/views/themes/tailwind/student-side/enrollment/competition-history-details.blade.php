...
@section('content')
            ...
            <div class="d-flex flex-column" id="content-wrapper"
                ...
                <div style="margin-bottom: 30px; position: absolute;" onclick="goBack()"><button class="button2" type="button"
                ...
                <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24bb"
                    style="margin-bottom: 50px;height: 31px;"><strong>Enrollment History</strong></p>
                        ...
                        <div>
                            <div class="d-xl-flex justify-content-between align-items-xl-center"
                                ...
                                <div class="d-xl-flex align-items-xl-center"><img
                                    ...
                                    <p class="p20b" style="margin-bottom: 0px;"><strong>Competition Details</strong></p>
                                </div>
                                <div class="complete status-bg-color_{{ $entry['status'] }}">
                            ...
                            <div class="d-xl-flex flex-column divcard frame" style="padding: 15px;padding-left: 30px;">
                                <div class="d-xxl-flex flex-column align-items-xxl-start">
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        ...
                                        <p class="p13" style="margin-right: 10px;margin-bottom: 0px;">Competition Name: </p>
                                        <p class="p13normal" style="margin-bottom: 0px;">{{ optional($entry['competition'])['competition_name'] }}</p>
                                    </div>
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;">
                                        <p class="p13" style="margin-right: 10px;margin-bottom: 0px;">Cometition Gender: </p>
                                        <p class="p13normal" style="margin-bottom: 0px;">{{ ucfirst(optional($entry['competition'])['competition_for_gender']) }}</p>
                                    </div>
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;">
                                        <p class="p13" style="margin-right: 10px;margin-bottom: 0px;">Cometition Type: </p>
                                        <p class="p13normal" style="margin-bottom: 0px;">{{ ucfirst(optional($entry['competition'])['competition_type']) }}</p>
                                    </div>
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;">
                                        <p class="p13" style="margin-right: 10px;margin-bottom: 0px;">Cometition Size: </p>
                                        <p class="p13normal" style="margin-bottom: 0px;">{{ optional($entry['competition'])['competition_size'] }}</p>
                                    </div>
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;">
                                    ...
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        ...
                                        <p class="p13normal" style="margin-bottom: 0px;">{{ optional($entry['competition']['school_venue_facility'])['name'] }}</p>
                                    </div>
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;">
                                        <p class="p13" style="margin-right: 10px;margin-bottom: 0px;">Date: </p>
                                        <p class="p13normal" style="margin-bottom: 0px;">{{ optional($entry['competition'])['start_date'] }} - {{ optional($entry['competition'])['end_date'] }}</p>
                                    </div>
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;">
                            ...
                            @if(! $entry['is_paid'] && $entry['status'] == 'reservation' )
                                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                    style="margin-top: 20px;margin-bottom: 10px;">
                                    <a class="button1 payment-button" type="button" href="{{ route('wave.competitionpayment', $entry['id']) }}">Go for Payment</a>
                                </div>
                            @endif
                        </div>
                    </div>
