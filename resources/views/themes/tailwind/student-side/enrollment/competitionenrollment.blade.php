...
<div class="d-flex flex-column" id="content-wrapper" style="padding: 50px;padding-top: 50px;padding-bottom: 50px;padding-right: 50px;padding-left: 50px;background: var(--app-color-tone-bg-color, #F1F2F9); width: 100%;">
    <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24bb" style="margin-bottom: 0px;height: 31px;"><strong>Competition Enrollment</strong></p>
    ...
    <div class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center">
        <div style="width: auto;">
            @if(!empty($students))
            <p class="p18b" style="margin-top: 50px;margin-bottom: 0px;">Choose student and get started on
                the</br>enrollment process</p>

            @foreach( $students as $student )
            <div style="margin-bottom: 20px;">
                <a href="{{ route('wave.competitionenrollment1', $student['id']) }}" class="d-xl-flex d-xxl-flex justify-content-around align-items-xl-center align-items-xxl-center divcard student-card" style="padding-right: 20px;padding-left: 20px;padding-top: 20px;padding-bottom: 20px; text-decoration: none; color: black;">
                    ...
                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center">
                        <p class="p18b" style="border: 1px solid; border-radius: 15px; padding: 0 20px; margin: 0;">
                            <strong>{{ optional($student['student_information'])['hkid'] }}</strong></p><svg xmlns="http://www.w3.org/2000/svg" viewBox="-96 0 512 512" width="1em" height="1em" fill="currentColor">
