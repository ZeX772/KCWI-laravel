                    ...
                    <div style="width: 50%; padding-top: 30px;">
                        <div class="progress beautiful progress-xs"
                            ...
                            <div class="progress-bar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"
                                style="width: 50%; background: var(--app-color-tone-testing, linear-gradient(180deg,rgba(127, 158, 211, 1) 0%, rgba(165, 208, 245, 1) 100%));">
                        ...
                        <form id="radioForm" action="{{route('wave.storeFullTermEnrollVenue')}}" method="post" onsubmit="return validate();">
                            @csrf
                            @if(isset($venues['response']) && $venues['response'] !== null && isset($venues['response']['venues']))
                                @foreach($venues['response']['venues'] as $Venue)
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                        style="margin-bottom: 10px;"><input type="radio" name="venueFullterm" id="option1"
                                            value="{{$Venue['id']}}">
                            ...
                            <div class="d-xl-flex d-xxl-flex justify-content-between align-items-xl-center align-items-xxl-center"
                                ...
                                <div><button class="button1 previous-button" type="button"
                                        onclick="window.location.href='{{ route('wave.fulltermenrollment1') }}'"><svg
...
@section('javascript')
    <script>
        function validate() {
            var radioButtons = document.getElementsByName('venueFullterm');
            var isChecked = false;
