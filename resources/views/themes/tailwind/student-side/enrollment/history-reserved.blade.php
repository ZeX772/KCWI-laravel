                    ...
                    <div style="width: 50%;">
                        <div>
                            <div class="d-xl-flex justify-content-between align-items-xl-center"
                                ...
                                <div class="reserved status-bg-color_{{ $entry['status'] }}" style="width: auto;">
                            ...
                            @if(! $entry['is_paid'] && $entry['status'] == 'reservation' )
                                <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center"
                                    ...
                                    <a class="button1 payment-button" type="button" href="{{ route('wave.reservation1', $entry['id']) }}">Go for Payment</a>
                                </div>
                            @endif
                        </div>
                    </div>
