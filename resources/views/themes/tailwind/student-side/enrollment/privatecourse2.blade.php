...
@section('content')
            ...
            <div class="d-flex flex-column" id="content-wrapper"
                ...
                <div style="margin-bottom: 30px; position: absolute;"
                    onclick="window.location.href='{{ route('wave.privatecourse1') }}'"><button class="button2"
                        type="button"
                    ...
                    <div style="width: 50%; padding-top: 30px;">
                        <div class="progress beautiful progress-xs"
                            ...
                            <div class="progress-bar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
                                style="width: 40%; background: var(--app-color-tone-testing, linear-gradient(180deg,rgba(127, 158, 211, 1) 0%, rgba(165, 208, 245, 1) 100%));">
                        ...
                        <form id="radioForm" action="{{route('wave.storePrivateCourseLevel')}}" method="post" onsubmit="return validate();">
                            @csrf
                            @if(isset($levels['response']) && $levels['response'] !== null)
                                @foreach($levels['response'] as $level)
                                    <div class="d-xl-flex d-xxl-flex align-items-xl-center align-items-xxl-center" style="margin-bottom: 10px;">
                                        <input type="radio" name="level_id" id="option1" value="{{ $level['id'] }}">
...
<script>
    function validate() {
        var radioButtons = document.getElementsByName('level_id');
        var isChecked = false;
