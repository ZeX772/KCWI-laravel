            ...
            <div class="d-flex flex-column" id="content-wrapper"
                ...
                <div style="width: 100%;margin-bottom: 30px;">
                    <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24b1"
                        style="margin-bottom: 60px;margin-top:-30px;height: 31px;text-align: center;"><strong>Leave/Make
                            up</strong></p>
                    <div
                        class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center"style="outline:none;">
                        <div style="width: 50%;">
                            <a href="{{ route('wave.apply-leave', $student_id) }}"style="text-decoration:none;color:black;">
                                <div class="box d-flex d-xxl-flex justify-content-start align-items-xxl-center  text-nowrap"
                                    type="button" style="margin-bottom: 10px;width: 100%;outline:none;"id="option1">
                                    <img src="{{ asset('/themes/tailwind/images/clipboard-image-57.png') }}" style="width: 100px;"
                                        class="image" data-original-src="{{ asset('/themes/tailwind/images/clipboard-image-57.png') }}">
                                    <strong class="p22bold">Apply for Leave</strong><span
                            ...
                            <a href="{{ route('wave.apply-makeup', $student_id) }}"style="text-decoration:none;color:black;">
                                <div class="box d-flex d-xxl-flex justify-content-start align-items-xxl-center button3 text-nowrap"
                                    type="button" style="margin-bottom: 10px;width: 100%;"id="option2">
                                    <img src="{{ asset('/themes/tailwind/images/clipboard-image-57.png') }}"
                                        style="width: 100px;"class="image"
                                        data-original-src="{{ asset('/themes/tailwind/images/clipboard-image-57.png') }}">
                                    <strong class="p22bold">Apply for Make Up</strong><span
                                        class="d-xxl-flex justify-content-xxl-end"
                                        style="width: 100%;text-align: right;"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            <a href="{{ route('wave.leave-record', $student_id) }}"style="text-decoration:none;color:black;">
                                <div class="box d-flex d-xxl-flex justify-content-start align-items-xxl-center button3 text-nowrap"
                                    ...
                                    <strong class="p22bold">Leave Records</strong><span
                                        class="d-xxl-flex justify-content-xxl-end" style="width: 100%;text-align: right;">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-96 0 512 512" width="1em"
                                            height="1em" fill="currentColor" class="d-xxl-flex">
                                            <path
                            ...
                            <a href="{{ route('wave.make-up.request', $student_id) }}"style="text-decoration:none;color:black;">
                                <div class="box d-flex d-xxl-flex justify-content-start align-items-xxl-center button3 text-nowrap"
                                    type="button" style="margin-bottom: 10px;width: 100%;" id="option4">
                                    <img src="{{ asset('/themes/tailwind/images/clipboard-image-59.png') }}" style="width: 100px;"
                                        class="image" data-original-src="{{ asset('/themes/tailwind/images/clipboard-image-59.png') }}">
                                    <strong class="p22bold">Make Up Request</strong><span
                                        class="d-xxl-flex justify-content-xxl-end" style="width: 100%;text-align: right;">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="-96 0 512 512" width="1em"
                                            height="1em" fill="currentColor" class="d-xxl-flex">
                                            <path
...
@section('javascript')
    <script>
        ...
        // Call handleHoverEffect function for each box with its unique ID and new image source
        handleHoverEffect('option1', "{{ asset('/themes/tailwind/images/pen1.png') }}");
        handleHoverEffect('option2', "{{ asset('/themes/tailwind/images/pen1.png') }}");
