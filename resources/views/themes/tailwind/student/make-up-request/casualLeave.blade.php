                ...
                <div class="d-xl-flex d-xxl-flex justify-content-xl-center align-items-xl-center justify-content-xxl-center"
                    ...
                    <div style="width: 50%;">
                        <div class="d-xl-flex justify-content-between align-items-xl-center" style="margin-bottom: 10px;">
                            ...
                            <div class="process status-color_{{$entry['status']}}">
                        ...
                        <div class="box d-xl-flex flex-column divcard" style="padding: 15px;margin-bottom: 10px;">
                            <div class="d-xl-flex d-xxl-flex justify-content-between align-items-xl-center align-items-xxl-center"
                                style="width: 100%;">
                                <p class="p28b" style="margin-bottom: 0px;padding-left:20px;margin-top:10px;">{{ $entry['reason'] }}
                                </p>
                            </div>
                            <div class="d-xxl-flex align-items-xxl-start">
                                <div class="table-responsive" style="width:auto;overflow-x:hidden;">
                                    <table class="table"style="margin-right:350px;">
                                        <tbody>
                                            <tr style="border-bottom: 2px solid rgba(171,171,171,0.26);">
                                                <td style="padding-right: -30px;"><svg xmlns="http://www.w3.org/2000/svg"
                                                        width="1em" height="1em" fill="currentColor"
                                                        viewBox="0 0 16 16" class="bi bi-circle-fill"
                                                        style="width: 8px;color: #233656;margin-top:4px;margin-right:-70px;">
                                                        <circle cx="8" cy="8" r="8"></circle>
                                                    </svg></td>
                                                <td class="p16b" style="text-align: left;padding-left:-200px;">Date</td>
                                                <td style="text-align: left;" class="p16b">{{ $entry['date_requested'] }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
