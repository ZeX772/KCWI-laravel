                ...
                <div class="d-md-flex d-xl-flex justify-content-md-center justify-content-xl-center"
                    ...
                    <div
                        ...
                        <button class="btn btn-primary" type="button"
                            style="width: 124px; background-color: var(--app-color-tone-secondary-2, #AAC9E4);filter: drop-shadow(0px 4px 4px rgba(35, 54, 86, 0.50));border-radius: 20px;border-style: none;padding-left: 20px;padding-right: 20px;color: #171433;">Upcoming</button></a>
                        <button class="btn btn-primary"
                            onclick="window.location.href='{{ route('wave.my-past-schedule', ['studentID' => $student_id]) }}'"
                            type="button"
                            style="width: 124px; border-color: white;border-style: none;background-color: white;color: #171433;border-radius: 20px;padding-left: 20px;padding-right: 20px; margin-left: -5px;">Past</button></a>
                    </div>
                </div>
                                            ...
                                            <div class="box d-xl-flex flex-column divcard"
                                                ...
                                                <div class="d-xxl-flex flex-column align-items-xxl-center">
                                                    ...
                                                    <button class="button1" type="button"
                                                        style="height: 12px;margin-top:-10px;">Invite friends to
                                                        join</button>
                                                </div>
                                            </div>
                                        @endforeach
