            ...
            <div class="d-flex flex-column" id="content-wrapper"
                ...
                <div style="width: 100%;margin-bottom: 30px;">
                    <p class="d-xl-flex justify-content-xl-center align-items-xl-center p24b1"
                        style="margin-bottom: 10px;margin-top:-30px;height: 31px;text-align: center;">
                ...
                <div class="d-xl-flex d-xxl-flex justify-content-xl-center justify-content-xxl-center" placeholder="">
                    <div style="min-width:50%;">
                        @foreach( $entries as $entry)
                            <a href="{{ route('wave.reservation1', $entry['id']) }}" style="text-decoration: none;">
                                <div class="box-container">
                                    <div class="box d-xl-flex d-xxl-flex justify-content-between divcard"
                                        style="padding: 20px;margin-bottom:20px;">
                                        <div style="display: flex; flex-direction: column; justify-content: flex-start;">
                                            <div style="display: flex; justify-content: flex-start;">
                                                <p class="p24b" style="margin-bottom: 0px;margin-right:30px;">Payment Details
                                                </p>
                                                <div class="process status-bg-color_processing">
                                                    <p class="text"style="margin-bottom: 0px;"><strong>Processing</strong></p>
                                                </div>
                                            </div>
                                            @foreach( $entry['active_filtered_student_classes'] as $student_class )
                                                <div class="mb-3">
                                                    <div style="display: flex; flex-direction: row;">
                                                        ...
                                                        <p style="margin-bottom: 0px;" class="p18b"><strong>{{ $student_class['class']['start_time'] }} - {{ $student_class['class']['end_time'] }}</strong></p>
                                                    </div>
                                                    <div style="display: flex; flex-direction: row;">
                                                        <p style="margin-bottom: 0px;color: #23365680;margin-right: 5px;"
                                                            class="p18b"><strong>Class Code:&nbsp;</strong></p>
                                                        <p style="margin-bottom: 0px;" class="p18b"><strong>{{ $student_class['class']['course_class_code'] }}</strong>
                                                        </p>
                                                    </div>
                                                </div>
                                            @endforeach
